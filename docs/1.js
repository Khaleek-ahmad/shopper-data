...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/add-category/add-category.component.html":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/add-category/add-category.component.html ***!
  \*********************************************************************************************************************/
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category-list/category-list.component.html":
/*!***********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category-list/category-list.component.html ***!
  \***********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p-toast></p-toast>\r\n\r\n\r\n<p-table [value]=\"categoryList\" dataKey=\"_id\" editMode=\"row\" [scrollable]=\"true\" [paginator]=\"true\" [rows]=\"7\">\r\n  <ng-template pTemplate=\"header\">\r\n      <tr>\r\n          <th>Id</th>\r\n          <th>Name</th>\r\n          <th>Image</th>\r\n         <th>Action</th>\r\n          <!-- <th style=\"width:8rem\"></th> -->\r\n      </tr>\r\n  </ng-template>\r\n  <ng-template pTemplate=\"body\" let-dataList let-editing=\"editing\" let-ri=\"rowIndex\">\r\n      <tr [pEditableRow]=\"dataList\">\r\n          <td>\r\n              <p-cellEditor>\r\n                  <ng-template pTemplate=\"input\">\r\n                      <input pInputText type=\"text\" [(ngModel)]=\"dataList._id\">\r\n                  </ng-template>\r\n                  <ng-template pTemplate=\"output\">\r\n                      {{dataList._id}}\r\n                  </ng-template>\r\n              </p-cellEditor>\r\n          </td>\r\n          <td>\r\n              <p-cellEditor>\r\n                  <ng-template pTemplate=\"input\">\r\n                      <input pInputText type=\"text\" [(ngModel)]=\"dataList.name\" required>\r\n                  </ng-template>\r\n                  <ng-template pTemplate=\"output\">\r\n               {{dataList.name}}\r\n                  </ng-template>\r\n              </p-cellEditor>\r\n          </td>\r\n          <td>\r\n              <p-cellEditor>\r\n                  <ng-template pTemplate=\"input\">\r\n                      <!-- <p-dropdown [options]=\"statuses\" [(ngModel)]=\"dataList.inventoryStatus\" [style]=\"{'width':'100%'}\"></p-dropdown> -->\r\n                      <input pInputText type=\"text\" [(ngModel)]=\"dataList.image\" required>\r\n                    </ng-template>\r\n                  <ng-template pTemplate=\"output\">\r\n                      {{dataList.image}}\r\n                  </ng-template>\r\n              </p-cellEditor>\r\n          </td>\r\n          <!-- <td>\r\n              <p-cellEditor>\r\n                  <ng-template pTemplate=\"input\">\r\n                      <input pInputText type=\"text\" [(ngModel)]=\"dataList.price\">\r\n                  </ng-template>\r\n                  <ng-template pTemplate=\"output\">\r\n                      {{dataList.price | currency: 'USD'}}\r\n                  </ng-template>\r\n              </p-cellEditor>\r\n          </td> -->\r\n          <td style=\"text-align:center\">\r\n              <button *ngIf=\"!editing\" pButton pRipple type=\"button\" pInitEditableRow icon=\"pi pi-pencil\" (click)=\"onRowEditInit(dataList)\" class=\"p-button-rounded p-button-text\"></button>\r\n              <button *ngIf=\"editing\" pButton pRipple type=\"button\" pSaveEditableRow icon=\"pi pi-check\" (click)=\"onRowEditSave(dataList)\" class=\"p-button-rounded p-button-text p-button-success p-mr-2\"></button>\r\n              <button *ngIf=\"editing\" pButton pRipple type=\"button\" pCancelEditableRow icon=\"pi pi-times\" (click)=\"onRowEditCancel(dataList, ri)\" class=\"p-button-rounded p-button-text p-button-danger\"></button>\r\n              <button *ngIf=\"!editing\"   pButton pRipple type=\"button\" pInitEditableRow_ icon=\"pi pi-trash\" (click)=\"onRowDeleteInit(dataList)\" class=\"p-button-rounded p-button-text\"></button>\r\n               </td>\r\n      </tr>\r\n  </ng-template>\r\n</p-table>\r\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category/category.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category/category.component.html ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n\r\n\r\n<div #scrollMe_ class=\"content-wrapper\">\r\n    <div class=\"container-fluid\">\r\n      <ngx-loading [show]=\"loading\" [config]=\"{ backdropBorderRadius: '3px' }\"></ngx-loading>\r\n  \r\n      <div class=\"row\">\r\n        <div class=\"col-md-12\">\r\n          <div class=\"my-3 p-3 bg-white rounded box-shadow\">\r\n            <div class=\"row\">\r\n              <div class=\"col-9\">\r\n                <h4><i>CATEGORY</i></h4>\r\n              </div>\r\n              <!-- <div class=\"col-3  text-right\"><button type=\"button\" class=\"btn btn-warning\"> + Add Category</button></div> -->\r\n            \r\n              <button class=\"badge badge-pill badge-success\" data-toggle=\"modal\" data-target=\"#myModal\"\r\n              (click)=\"addNewCategory()\">Add New Category</button>\r\n              <!-- <span class=\"badge badge-pill badge-success\">Success</span> -->\r\n            </div>\r\n  \r\n          </div>\r\n        </div>\r\n      </div>\r\n  \r\n  \r\n      <div class=\"row\">\r\n        <div class=\"col-md-12\">\r\n  \r\n          <!-- <h2 class=\"d-flex justify-content-between pageheading heading-border pb-3\">\r\n                      <span>Agent</span>                  \r\n                  </h2>                -->\r\n          <!-- <div class=\"my-3 p-3 bg-white rounded box-shadow\">\r\n                    <span>Agent</span> \r\n  \r\n                    <div class=\"col-4 d-flex justify-content-end align-items-center\">\r\n                      <a class=\"text-muted\" href=\"#\" aria-label=\"Search\">\r\n                        <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" class=\"mx-3\" role=\"img\" viewBox=\"0 0 24 24\" focusable=\"false\"><title>Search</title><circle cx=\"10.5\" cy=\"10.5\" r=\"7.5\"></circle><path d=\"M21 21l-5.2-5.2\"></path></svg>\r\n                      </a>\r\n                      <a class=\"btn btn-sm btn-outline-secondary\" href=\"#\">Sign up</a>\r\n                    </div>\r\n  \r\n               </div>    -->\r\n  \r\n          <div class=\"my-3 p-3 bg-white rounded box-shadow\">\r\n              <app-category-list></app-category-list>\r\n            <!--<p-table #dt [columns]=\"cols\" [value]=\"angentList\" [scrollable]=\"true\" [paginator]=\"true\" [rows]=\"18\">\r\n              <ng-template pTemplate=\"header\">\r\n                <tr>\r\n  \r\n                  <ng-container *ngFor=\"let col of cols\">\r\n                    <th [pSortableColumn]=\"col.field\" [style.width]=\"col.field == 'status' ? '200px' : null\">\r\n                      {{col.header}}\r\n                      <p-sortIcon [field]=\"col.field\"></p-sortIcon>\r\n                    </th>\r\n                  </ng-container>\r\n                </tr>\r\n              </ng-template>\r\n  \r\n              <ng-template pTemplate=\"body\" let-rowData let-columns=\"columns\">\r\n                <tr style=\"height:30px\">\r\n                  <td *ngFor=\"let col of cols\">\r\n                    {{rowData[col.field]}}\r\n                  </td>\r\n                </tr>\r\n              </ng-template>\r\n            </p-table> \r\n  --> \r\n  \r\n  <!-- [showJumpToPageDropdown]=\"true\" (onLazyLoad)=\"loadPartnerLazy($event)\"-->\r\n  \r\n            <!-- <p-table #dt [columns]=\"columns\" [value]=\"angentList\" class=\"table table-hover mb-0  table-bordered\" [lazy]=\"true\"\r\n             [rows]=\"10\" [rowsPerPageOptions]=\"[10,20,30]\" [totalRecords]=\"totalRecords\" [paginator]=\"true\"\r\n            \r\n            >\r\n            <ng-template pTemplate=\"header\">\r\n              <tr>            \r\n                <ng-container *ngFor=\"let col of columns;\">\r\n                  <th [pSortableColumn]=\"col.field\" [style.width]=\"col.field == 'status' ? '200px' : null\">\r\n                    {{col.header}}\r\n                    <p-sortIcon [field]=\"col.field\"></p-sortIcon>\r\n                  </th>\r\n                </ng-container>\r\n              </tr>\r\n            </ng-template>\r\n            <ng-template pTemplate=\"body\" let-rowData let-columns=\"columns\" let-i=\"rowIndex\" style=\"width:auto;\">\r\n              <ng-container>\r\n                <tr class=\"table-hover\" [pSelectableRow]=\"rowData\" style=\"height:34px\">\r\n                  \r\n                  <td *ngFor=\"let col of columns\">\r\n                    <ng-container [ngSwitch]=\"col.field\">\r\n                      <ng-container *ngSwitchCase=\"'status'\">\r\n                             <i class=\"status\" [ngClass]=\"{\r\n                              'bg-success': rowData[col.field]  === 'Active',\r\n                              'badge-secondary': rowData[col.field]  === 'InActive',\r\n                              'bg-warning': rowData[col.field]  === 'OnHold',\r\n                              'badge-danger': rowData[col.field]  === 'Rejected'}\"></i> {{rowData[col.field]}}\r\n                      </ng-container>\r\n          \r\n                      <ng-container *ngSwitchCase=\"'partnerName'\">\r\n                        <a class=\"linkTag\"\r\n                          (click)=\"redirectToViewPartner(rowData.id)\"> {{rowData[col.field]}}</a>\r\n                      </ng-container>\r\n          \r\n                      <ng-container *ngSwitchDefault>{{rowData[col.field]}} </ng-container>\r\n                    </ng-container>\r\n                  </td>\r\n                </tr>\r\n              </ng-container>\r\n            </ng-template>\r\n          </p-table> -->\r\n  \r\n  \r\n  \r\n  \r\n          </div>\r\n        </div>\r\n      </div>\r\n      <br /><br />\r\n    </div>\r\n  </div>\r\n\r\n\r\n  <app-dialog [(visible)]=\"isShowCreateCategory\" (onVisibleChanged)=\"onVisibledChange($event)\">\r\n    <!-- <app-create-partner (close)=\"onClose($event)\"></app-create-partner> -->\r\n    <app-add-category (close)=\"onClose($event)\"></app-add-category>\r\n  </app-dialog>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/order/order.component.html":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/order/order.component.html ***!
  \*******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>Page is under construction</p>\r\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/product/product.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/product/product.component.html ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/dialogue-model/alert-view/alert-view.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/dialogue-model/alert-view/alert-view.component.html ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <div [@dialog] *ngIf=\"visible\" class=\"dialog\" > -->\r\n<!-- <div [@dialog] *ngIf=\"visible\" #myIdentifier [ngClass]=\"max?' dialog1':'dialog'\" style=\"max-width:500px;\" > -->\r\n\t<div [@dialog] *ngIf=\"visible\" #myIdentifier [ngClass]=\"max?' dialog1':'dialog'\" [ngStyle]=\"mystyle\" >\r\n\r\n\t\r\n\r\n\t<ng-content></ng-content> \r\n\t<button *ngIf=\"closable\" (click)=\"close()\" aria-label=\"Close\" class=\"dialog__close-btn\"><i class=\"fa fa-times\"></i></button>\r\n\t <!-- <button   (click)=\"maximize()\" aria-label=\"Maximize\" class=\"dialog__Maximize-btn\">#</button> \r\n\t<button   (click)=\"minimize()\" aria-label=\"Minimize\" class=\"dialog__Minimize-btn\">-</button>  -->\r\n\r\n</div>\r\n<div *ngIf=\"visible\" class=\"overlay\" (click)=\"close()\"></div>\r\n\r\n\r\n\r\n\r\n");

/***/ }),

/***/ "./src/app/dashboard/components/add-category/add-category.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/dashboard/components/add-category/add-category.component.css ***!
  \******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Rhc2hib2FyZC9jb21wb25lbnRzL2FkZC1jYXRlZ29yeS9hZGQtY2F0ZWdvcnkuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/dashboard/components/add-category/add-category.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/dashboard/components/add-category/add-category.component.ts ***!
  \*****************************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js"), __webpack_require__(/*! ../../../services/category.service */ "./src/app/services/category.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, forms_1, category_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    AddCategoryComponent = tslib_1.__decorate([
        core_1.Component({
            ...
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./add-category.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/add-category/add-category.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./add-category.component.css */ "./src/app/dashboard/components/add-category/add-category.component.css")).default]
        })
...
/***/ "./src/app/dashboard/components/add-tutorial/add-tutorial.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/dashboard/components/add-tutorial/add-tutorial.component.css ***!
  \******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".submit-form {\r\n  max-width: 400px;\r\n  margin: auto;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/dashboard/components/add-tutorial/add-tutorial.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/dashboard/components/add-tutorial/add-tutorial.component.ts ***!
  \*****************************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! src/app/services/tutorial.service */ "./src/app/services/tutorial.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, tutorial_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    AddTutorialComponent.ctorParameters = () => [
        { type: tutorial_service_1.TutorialService }
    ];
    AddTutorialComponent = tslib_1.__decorate([
        core_1.Component({
            selector: 'app-add-tutorial',
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./add-tutorial.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/add-tutorial/add-tutorial.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./add-tutorial.component.css */ "./src/app/dashboard/components/add-tutorial/add-tutorial.component.css")).default]
        })
...
/***/ "./src/app/dashboard/components/category-list/category-list.component.css":
/*!********************************************************************************!*\
  !*** ./src/app/dashboard/components/category-list/category-list.component.css ***!
  \********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".list {\r\n  text-align: left;\r\n  max-width: 750px;\r\n  margin: auto;\r\n}\r\n\r\n:host ::ng-deep .ui-table table td, th {\r\n  border-bottom: 1px solid rgb(212, 212, 212) !important;\r\n}\r\n\r\n/* :host ::ng-deep .ui-table table th {\r\n  background: #ece7df !important;\r\n} */\r\n\r\n:host ::ng-deep .ui-table table tr:nth-child(even) {\r\n  background: #fdfcfb !important;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/dashboard/components/category-list/category-list.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/dashboard/components/category-list/category-list.component.ts ***!
  \*******************************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! src/app/services/category.service */ "./src/app/services/category.service.ts"), __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js"), __webpack_require__(/*! primeng/api */ "./node_modules/primeng/api.js"), __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, category_service_1, platform_browser_1, api_1, ngx_toastr_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let CategoryListComponent = class CategoryListComponent {
        constructor(CategoryService, toasterService, sanitizer, messageService) {
            this.CategoryService = CategoryService;
        ...
        onRowEditInit(data) {
            // debugger;
            this.clonedProducts[data._id] = Object.assign({}, data);
        }
        onRowDeleteInit(data) {
            debugger;
            this.clonedProducts[data._id] = Object.assign({}, data);
        }
        onRowEditSave(data) {
    ...
    CategoryListComponent.ctorParameters = () => [
        ...
        { type: api_1.MessageService }
    ];
    CategoryListComponent = tslib_1.__decorate([
        core_1.Component({
            selector: 'app-category-list',
            providers: [api_1.MessageService],
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./category-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category-list/category-list.component.html")).default,
            styles: ["\n      :host ::ng-deep .p-cell-editing {\n        padding-top: 0 !important;\n        padding-bottom: 0 !important;\n      }\n    ", tslib_1.__importDefault(__webpack_require__(/*! ./category-list.component.css */ "./src/app/dashboard/components/category-list/category-list.component.css")).default]
        })
...
/***/ "./src/app/dashboard/components/category/category.component.scss":
/*!***********************************************************************!*\
  !*** ./src/app/dashboard/components/category/category.component.scss ***!
  \***********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".nav-scroller {\n  position: relative;\n  z-index: 2;\n  /* //height: 2.75rem; */\n  overflow-y: hidden;\n  /* // margin-top: -2em; */\n}\n\n.nav-scroller nav {\n  /* // margin-right: -1em; */\n  padding: 0.5rem 0;\n}\n\n.bg-white {\n  background-color: #fff !important;\n}\n\n.box-shadow {\n  box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.05);\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/dashboard/components/category/category.component.ts":
/*!*********************************************************************!*\
  !*** ./src/app/dashboard/components/category/category.component.ts ***!
  \*********************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1) {
    ...
    CategoryComponent = tslib_1.__decorate([
        core_1.Component({
            ...
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./category.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/category/category.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./category.component.scss */ "./src/app/dashboard/components/category/category.component.scss")).default]
        })
    ], CategoryComponent);
...
/***/ "./src/app/dashboard/components/order/order.component.scss":
/*!*****************************************************************!*\
  !*** ./src/app/dashboard/components/order/order.component.scss ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Rhc2hib2FyZC9jb21wb25lbnRzL29yZGVyL29yZGVyLmNvbXBvbmVudC5zY3NzIn0= */");

/***/ }),

/***/ "./src/app/dashboard/components/order/order.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/dashboard/components/order/order.component.ts ***!
  \***************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1) {
    ...
    OrderComponent = tslib_1.__decorate([
        core_1.Component({
            selector: 'app-order',
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./order.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/order/order.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./order.component.scss */ "./src/app/dashboard/components/order/order.component.scss")).default]
        })
    ], OrderComponent);
...
/***/ "./src/app/dashboard/components/product/product.component.scss":
/*!*********************************************************************!*\
  !*** ./src/app/dashboard/components/product/product.component.scss ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Rhc2hib2FyZC9jb21wb25lbnRzL3Byb2R1Y3QvcHJvZHVjdC5jb21wb25lbnQuc2NzcyJ9 */");

/***/ }),

/***/ "./src/app/dashboard/components/product/product.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/dashboard/components/product/product.component.ts ***!
  \*******************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1) {
    ...
    ProductComponent = tslib_1.__decorate([
        core_1.Component({
            ...
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./product.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/components/product/product.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./product.component.scss */ "./src/app/dashboard/components/product/product.component.scss")).default]
        })
    ], ProductComponent);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js"), __webpack_require__(/*! ./components/category-list/category-list.component */ "./src/app/dashboard/components/category-list/category-list.component.ts"), __webpack_require__(/*! ./components/category/category.component */ "./src/app/dashboard/components/category/category.component.ts"), __webpack_require__(/*! ./components/order/order.component */ "./src/app/dashboard/components/order/order.component.ts"), __webpack_require__(/*! ./components/product/product.component */ "./src/app/dashboard/components/product/product.component.ts"), __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/dashboard/dashboard/dashboard.component.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, router_1, category_list_component_1, category_component_1, order_component_1, product_component_1, dashboard_component_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const routes = [
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js"), __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/dashboard/dashboard/dashboard.component.ts"), __webpack_require__(/*! ./dashboard-routing.module */ "./src/app/dashboard/dashboard-routing.module.ts"), __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js"), __webpack_require__(/*! primeng/table */ "./node_modules/primeng/table.js"), __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js"), __webpack_require__(/*! primeng/calendar */ "./node_modules/primeng/calendar.js"), __webpack_require__(/*! ngx-loading */ "./node_modules/ngx-loading/ngx-loading/ngx-loading.js"), __webpack_require__(/*! ./components/add-category/add-category.component */ "./src/app/dashboard/components/add-category/add-category.component.ts"), __webpack_require__(/*! ./components/product/product.component */ "./src/app/dashboard/components/product/product.component.ts"), __webpack_require__(/*! ./components/order/order.component */ "./src/app/dashboard/components/order/order.component.ts"), __webpack_require__(/*! ./components/category/category.component */ "./src/app/dashboard/components/category/category.component.ts"), __webpack_require__(/*! ./components/category-list/category-list.component */ "./src/app/dashboard/components/category-list/category-list.component.ts"), __webpack_require__(/*! primeng/paginator */ "./node_modules/primeng/paginator.js"), __webpack_require__(/*! ../dialogue-model/dialogue-model.module */ "./src/app/dialogue-model/dialogue-model.module.ts"), __webpack_require__(/*! ./components/add-tutorial/add-tutorial.component */ "./src/app/dashboard/components/add-tutorial/add-tutorial.component.ts"), __webpack_require__(/*! primeng/toast */ "./node_modules/primeng/toast.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, common_1, dashboard_component_1, dashboard_routing_module_1, forms_1, table_1, http_1, calendar_1, ngx_loading_1, add_category_component_1, product_component_1, order_component_1, category_component_1, category_list_component_1, paginator_1, dialogue_model_module_1, add_tutorial_component_1, toast_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    DashboardModule = tslib_1.__decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                table_1.TableModule,
                dialogue_model_module_1.DialogueModelModule,
                paginator_1.PaginatorModule,
                http_1.HttpClientModule,
                calendar_1.CalendarModule,
                toast_1.ToastModule,
                ngx_loading_1.NgxLoadingModule
            ],
            providers: []
        })
    ], DashboardModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".calendar_wrap {\n  display: flex;\n}\n\n.calendar_wrap .close_calendar {\n  border: 0;\n  margin: 0 0 0 -25px;\n  position: relative;\n  background: none;\n  cursor: pointer;\n  font-size: 18px;\n}\n\n.dropdown-menu {\n  transform: none !important;\n  top: inherit !important;\n  left: inherit !important;\n  will-change: auto !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1) {
    ...
    DashboardComponent = tslib_1.__decorate([
        core_1.Component({
            ...
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./dashboard.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/dashboard/dashboard.component.html")).default,
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./dashboard.component.scss */ "./src/app/dashboard/dashboard/dashboard.component.scss")).default]
        })
    ], DashboardComponent);
...
/***/ "./src/app/dialogue-model/alert-view/alert-view.component.css":
/*!********************************************************************!*\
  !*** ./src/app/dialogue-model/alert-view/alert-view.component.css ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".overlay {\r\n  display:inline-block;\r\n    position: fixed;\r\n    top: 0;\r\n    bottom: 0;\r\n    left: 0;\r\n    right: 0;\r\n    width: 100%;\r\n    height:100%;\r\n    background: rgba(51, 51, 51, 0.7);\r\n    z-index: 999;\r\n  }\r\n  \r\n  .dialog {\r\n    z-index: 1000;\r\n    position: fixed;\r\n    right: 0;\r\n    left: 0;\r\n    top: 20px;\r\n    border: 1px solid rgba(0, 0, 0, 0.117647);\r\n    border-radius: 4px;\r\n    margin-right: auto;\r\n    margin-left: auto;\r\n    min-height: 200px;\r\n    width: 50%;\r\n    max-width: 900px;\r\n    background-color: #fff;\r\n    padding: 12px;\r\n    box-shadow: 0 7px 8px -4px rgba(0, 0, 0, 0.2), 0 13px 19px 2px rgba(0, 0, 0, 0.14), 0 5px 24px 4px rgba(0, 0, 0, 0.12);\r\n  }\r\n  \r\n  .dialog1 {\r\n    z-index: 1000;\r\n    position: fixed;\r\n    right: 0;\r\n    left: 0;\r\n    top: 20px;\r\n    border: 1px solid rgba(0, 0, 0, 0.117647);\r\n    border-radius: 4px;\r\n    margin-right: auto;\r\n    margin-left: auto;\r\n    height: 900px;\r\n    width: 90%;\r\n   \r\n    background-color: #fff;\r\n    padding: 12px;\r\n    box-shadow: 0 7px 8px -4px rgba(0, 0, 0, 0.2), 0 13px 19px 2px rgba(0, 0, 0, 0.14), 0 5px 24px 4px rgba(0, 0, 0, 0.12);\r\n  }\r\n  \r\n  @media (min-width: 768px) {\r\n    .dialog {\r\n      top: 20px;\r\n    }\r\n  }\r\n  \r\n  .dialog__close-btn {\r\n    border: 0;\r\n    border-color:transparent;\r\n    background-color:transparent;\r\n    color: #000;\r\n    position: absolute;\r\n    top: 8px;\r\n    right: 8px;\r\n    font-size: 1.2em;\r\n  }\r\n  \r\n  .dialog__Maximize-btn {\r\n    border: 0;\r\n    border-color: #c03d05;\r\n    background-color: #ff5f16;\r\n    color: #ffffff;\r\n    position: absolute;\r\n    top: 8px;\r\n    right: 34px;\r\n    font-size: 1.2em;\r\n  }\r\n  \r\n  .dialog__Minimize-btn{\r\n    border: 0;\r\n    border-color: #c03d05;\r\n    background-color: #ff5f16;\r\n    color: #ffffff;\r\n    position: absolute;\r\n    top: 8px;\r\n    right: 58px;\r\n    font-size: 1.2em;\r\n  }\r\n  \r\n  .dialog{padding:0; border:0;}\r\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/dialogue-model/alert-view/alert-view.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/dialogue-model/alert-view/alert-view.component.ts ***!
  \*******************************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/animations */ "./node_modules/@angular/animations/fesm2015/animations.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, animations_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let AlertViewComponent = class AlertViewComponent {
        ...
        constructor() {
            this.closable = true;
            //@Input() setwidth;
            this.onVisibleChanged = new core_1.EventEmitter();
            this.visible = true;
    ...
    tslib_1.__decorate([
        core_1.Input()
    ], AlertViewComponent.prototype, "closable", void 0);
    tslib_1.__decorate([
        core_1.Input()
    ], AlertViewComponent.prototype, "visible", void 0);
    tslib_1.__decorate([
        core_1.Output()
    ], AlertViewComponent.prototype, "onVisibleChanged", void 0);
    AlertViewComponent = tslib_1.__decorate([
        core_1.Component({
            selector: 'app-dialog',
            template: tslib_1.__importDefault(__webpack_require__(/*! raw-loader!./alert-view.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dialogue-model/alert-view/alert-view.component.html")).default,
            animations: [
            ...
            styles: [tslib_1.__importDefault(__webpack_require__(/*! ./alert-view.component.css */ "./src/app/dialogue-model/alert-view/alert-view.component.css")).default]
        })
    ], AlertViewComponent);
    exports.AlertViewComponent = AlertViewComponent;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ "./src/app/dialogue-model/dialogue-model.module.ts":
/*!*********************************************************!*\
  !*** ./src/app/dialogue-model/dialogue-model.module.ts ***!
  \*********************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js"), __webpack_require__(/*! ./alert-view/alert-view.component */ "./src/app/dialogue-model/alert-view/alert-view.component.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, common_1, alert_view_component_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let DialogueModelModule = class DialogueModelModule {
    };
    DialogueModelModule = tslib_1.__decorate([
        core_1.NgModule({
            declarations: [alert_view_component_1.AlertViewComponent],
            imports: [
                common_1.CommonModule
            ],
            exports: [alert_view_component_1.AlertViewComponent]
        })
    ], DialogueModelModule);
    exports.DialogueModelModule = DialogueModelModule;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js"), __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js"), __webpack_require__(/*! ../shared/HttpService */ "./src/app/shared/HttpService.ts"), __webpack_require__(/*! src/app/shared/App.Config */ "./src/app/shared/App.Config.ts"), __webpack_require__(/*! src/app/shared/Constant */ "./src/app/shared/Constant.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, core_1, http_1, HttpService_1, App_Config_1, Constant_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let CategoryService = class CategoryService {
        ...
        getAll() {
            //debugger;
            let url = this.apiServer[Constant_1.Constants.BASE_URL] + this.apiServer[Constant_1.Constants.CATEGORY][Constant_1.Constants.CATEGORYLIST];
            return this._http.getService(url, null);
        }
        update(id, data) {
            debugger;
            let httpOptions = new http_1.HttpHeaders();
            httpOptions = httpOptions.set('x-access-token', JSON.stringify(sessionStorage.getItem('userToken')));
            let url = this.apiServer[Constant_1.Constants.BASE_URL] + this.apiServer[Constant_1.Constants.CATEGORY][Constant_1.Constants.CATEGORYID];
